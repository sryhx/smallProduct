...
function getSign(e, t, n) {
  ...
  // g < i.length - 1 && (c += "&"));
  for (var c = "", g = 0; g < i.length; g++) i[g] && i[g].name && (c += i[g].name + "=" + i[g].value,
  g < i.length - 1 && (c += "&"));
// console.log(c + (n = n || getApp().siteInfo.api_secret));
  return o = r(c + (n = n || getApp().siteInfo.api_secret));
}

util.url = function(e, t) {
  var n = getApp(), a = n.siteInfo.siteroot + e + "?v=" + n.siteInfo.version + "&from=wxapp&";
  ...
  var e = function() {
      ...
      wx.login({
          success: function(e) {
              console.log("res.code" + e.code), util.request({
                  ...
                  cachetime: 0,
                  success: function(e) {
                      e.data.errno || (t.openid = e.openid, t.sessionid = e.session_key, wx.setStorageSync("userInfo", t), 
                      wx.getUserInfo({
                          success: function(e) {
